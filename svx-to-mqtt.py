...
MQTT_QOS       = 0                    # QoS auswählen: 0, 1 oder 2
...
def make_client():
    # MQTT v3.1.1 und Callback API v2
    client = mqtt.Client(
        callback_api_version=CallbackAPIVersion.VERSION2,
        client_id=MQTT_CLIENT_ID,
        protocol=mqtt.MQTTv311
    )
    # client.enable_logger()  # zum Debuggen einschalten
...
def main():
    ...
    # Default-Werte: falls nie ein Reflector-Event kommt
    state = {
        "time": "",
        "talker": "0",
        "TG": "N0TG",         # Default Talkgroup, wenn kein Reflector-Eintrag gefunden
        "Call": "N0Call",     # Default Rufzeichen, wenn kein Reflector-Eintrag gefunden
        "tx": "0",
        "rx": "0",
    }
